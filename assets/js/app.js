  ...
  function s(e) {
    1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (t("#dark-mode-switch").prop("checked", !1),
        ...
        t("#bootstrap-style").attr("href", "<?php echo base_url('assets/css/bootstrap.min.css') ?>"),
        t("#app-style").attr("href", "<?php echo base_url('assets/css/app.min.css') ?>"),
        sessionStorage.setItem("is_visited", "light-mode-switch"))
      : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
      ? (t("#light-mode-switch").prop("checked", !1),
        t("#rtl-mode-switch").prop("checked", !1),
        t("#bootstrap-style").attr("href", "<?php echo base_url('assets/css/bootstrap-dark.min.css"),
        t("#app-style").attr("href", "<?php echo base_url('assets/css/app-dark.min.css') ?>"),
      ...
      : 1 == t("#rtl-mode-switch").prop("checked") &&
        ...
        t("#dark-mode-switch").prop("checked", !1),
        t("#bootstrap-style").attr("href", "<?php echo base_url('assets/css/bootstrap.min.css') ?>"),
        t("#app-style").attr("href", "<?php echo base_url('assets/css/app-rtl.min.css') ?>"),
