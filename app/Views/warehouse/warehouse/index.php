...
<div class="container-fluid">
    ...
    <div class="button-items text-right">
        <a href="<?php echo base_url('warehouse/warehouse/create') ?>" class="btn btn-primary waves-effect waves-light"><i class="fas fa-plus-square"></i> เพิ่มข้อมูล</a>
                ...
                <div id="wf_space" class="card-body">
                    <form name="form_search" id="form_search" method="post" action="#">
                        ...
                        <div class="form-group row">
                            <label for="s_prefix_name_th" class="col-md-2 col-form-label hm-right">คลังสินค้า (TH)</label>
                            <div class="col-md-3">
                            ...
                            <label for="s_prefix_name_en" class="col-md-2 col-form-label hm-right">คลังสินค้า (EN)</label>
                            <div class="col-md-3">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12 text-center">
                                ...
                                <button type="button" onclick="window.location.href='<?php echo base_url('warehouse/warehouse') ?>';" class="btn btn-warning"><i class="fas fa-undo"></i> ล้างการค้นหา</button>
                            </div>
                        </div>
                    </form>
                        ...
                        <table class="table table-centered table-nowrap table-hover">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 20%;">คลังสินค้า (TH)</th>
                                    <th class="text-center" style="width: 20%;">คลังสินค้า (EN)</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-left" ><?php echo $val['wh_name_th']?></td> 
                                    <td class="text-left" ><?php echo $val['wh_name_en']?></td>
                                    <td class="text-left" ><?php echo getShowAddress($val['address'],$val['province_id'],$val['amphure_id'],$val['tambon_id'],$val['zipcode'],$tel=''); ?></td>
                                    <td class="text-center" ><?php echo getStatus((string)$val['active_status']);?></td>
                                    <td class="text-center" style="width: 10%;">
                                        &nbsp;<a href="<?php echo base_url('/warehouse/warehouse/update/'.$val['wh_id']); ?>" class="btn btn-success btn-sm waves-effect waves-light"><i class="fas fa-pencil-alt"></i></a>
                                        &nbsp;<a href="<?php echo base_url('/warehouse/warehouse/view/'.$val['wh_id']); ?>" class="btn btn-info btn-sm waves-effect waves-light"><i class="fas fa-search"></i></a>
                                        &nbsp;<a href="#!" onclick="getDelete('<?php echo $val['wh_id']; ?>');" class="btn btn-danger btn-sm waves-effect waves-light"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                                    }
    ...
    function getDelete(id){
        if(id != ''){
            swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseUrl+ "/warehouse/warehouse/delete/"+id,
                        data: dataString,
                        cache: false,
                        dataType: 'json',
                        success: function(response){
                            if(response.statusCode == 150){
                                refresh('<?php echo base_url('warehouse/warehouse') ?>');
                            }else{
