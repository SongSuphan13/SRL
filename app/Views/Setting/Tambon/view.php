                    ...
                    <form name="form_view" id="form_view" method="post" action="#">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                             ...
                             <label for="province_code" class="col-md-2 col-form-label hm-right">อำเภอ (TH)<span style="color: #f46a6a">*</span></label>
                            <div class="col-md-3">
                                <?php  
                                    echo isset($amphure_name_th)?$amphure_name_th:''; 
                                ?> 
                             </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <?php echo isset($objData['tambon_name_th'])?$objData['tambon_name_th']:''; ?>
                             </div>
                            <label for="tambon_name_en" class="col-md-2 col-form-label hm-right">ตำบล (EN)</label>
                            <div class="col-md-3">
                                <?php echo isset($objData['tambon_name_en'])?$objData['tambon_name_en']:''; ?>
                            </div>
                        </div>
                        <div class="form-group row">
