...
<div class="container-fluid">
    ...
    <div class="button-items text-right">
        <a href="<?php echo base_url('product/product_type/create') ?>" class="btn btn-primary waves-effect waves-light"><i class="fas fa-plus-square"></i> เพิ่มข้อมูล</a>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div id="wf_space" class="card-body">
                    <form name="form_search" id="form_search" method="post" action="<?php echo base_url('product/product_type/') ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12 text-center">
                                ...
                                <button type="button" onclick="window.location.href='<?php echo base_url('product/product_type') ?>';" class="btn btn-warning"><i class="fas fa-undo"></i> ล้างการค้นหา</button>
                            </div>
                        </div>
                    </form>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <nobr>
                                                &nbsp;<a href="<?php echo base_url('/product/product_type/edit/'.$val['prodtype_id']); ?>" class="btn btn-success btn-sm waves-effect waves-light"><i class="fas fa-pencil-alt"></i></a>
                                                &nbsp;<a href="<?php echo base_url('/product/product_type/view/'.$val['prodtype_id']); ?>" class="btn btn-info btn-sm waves-effect waves-light"><i class="fas fa-search"></i></a>
    ...
    function getDelete(id){
        if(id != ''){
            swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseUrl+ "/product/product_type/delete/"+id,
                        data: dataString,
                        cache: false,
                        dataType: 'json',
                        success: function(response){
                            if(response.statusCode == 150){
                                window.location.href = '<?php echo base_url('product/product_type') ?>';
                            }else{
