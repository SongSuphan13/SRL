    ...
    <script>
        function get_save(){
            ...
            if($('input[id=prodtype_code]:required').val() == ''){
                ...
                $('input[id=prodtype_code]:required').after(brfore+'กรุณาระบุรหัสประเภทสินค้า'+after)
                required++;
            }
            if($('input[id=prodtype_name_th]:required').val() == ''){
                $('input[id=prodtype_name_th]:required').addClass("is-invalid");
                $('input[id=prodtype_name_th]:required').after(brfore+'กรุณาระบุประเภทสินค้า (TH)'+after)
                required++;
            }
