                ...
                <div id="wf_space" class="card-body">
                    <form name="form_save" id="form_save" method="post" action="#">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_seq'])?$objData['prodtype_seq']:''; ?>
                            </div>
                            <label for="prodtype_code" class="col-md-2 col-form-label hm-right">รหัสประเภทสินค้า <span style="color: #f46a6a">*</span></label>
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_code'])?$objData['prodtype_code']:''; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="prodtype_name_th" class="col-md-2 col-form-label hm-right">ประเภทสินค้า (TH) <span style="color: #f46a6a">*</span></label>
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_name_th'])?$objData['prodtype_name_th']:''; ?>
                             </div>
                            <label for="prodtype_name_en" class="col-md-2 col-form-label hm-right">ประเภทสินค้า (EN)</label>
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_name_en'])?$objData['prodtype_name_en']:''; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="prodtype_nameshort_th" class="col-md-2 col-form-label hm-right">ประเภทสินค้าย่อ (TH)</label>
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_nameshort_th'])?$objData['prodtype_nameshort_th']:''; ?>
                             </div>
                            <label for="prodtype_nameshort_en" class="col-md-2 col-form-label hm-right">ประเภทสินค้าย่อ (EN)</label>
                            <div class="col-md-3">
                                <?php echo isset($objData['prodtype_nameshort_en'])?$objData['prodtype_nameshort_en']:''; ?>
                            </div>
                        </div>
                        <div class="form-group row">
